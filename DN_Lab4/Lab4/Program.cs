...
[Command(Name = "dim4", Description = "FIT, IPZ-42, Dmytro Nahirnyak, Crossplatform, lab4"),
...
class Lab4
{
    ...
    private class Version
    {
        ...
        {
            Console.WriteLine("Dmytro Nahirnyak IPZ-42");
    ...
    private class Run
    {
        ...
        private class Lab1Presenter : Labs
        {
        ...
        private class Lab2Presenter : Labs
        {
            protected override int OnExecute(IConsole console)
            {
                string inputData = ReadInputFile();
        ...
        private class Lab3Presenter : Labs
        {
            protected override int OnExecute(IConsole console)
            {
                string inputData = ReadInputFile();
